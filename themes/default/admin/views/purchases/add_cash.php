...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Cash Management'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo admin_form_open_multipart("purchases/add_cash", $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input name="category" type="text" id="category" value="" class="pa form-control kb-pad"
                       required="required"/>
                <!-- <?php
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_cash', lang('Update'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
