    ...
    <div class="tableRow">
        <div class="tableRowItem">
            <div class="tableRowHeading">
                <h2>
                    <?= lang('purchases') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
                </h2>
            </div>
                ...
                <table class="table display dTable" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <!-- <th><img src="<?= $assets ?>images/icon/chain.svg" class="svg" alt=""></th> -->
                            <th><?= lang('actions'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="POData" cellpadding="0" cellspacing="0" border="0" class="table table_theme">
                        <thead>
                            <tr class="active">
