...
<script>
    $(document).ready(function() {
        ...
        oTable = $('#EXPData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= admin_url('purchases/getCash'); ?>',
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="small-box padding1010 col-sm-4 bblue">
                        <h3><?= isset($head->cash_inhand) ? $this->sma->formatMoney($head->cash_inhand) : '0.00' ?></h3>
                        <p><?= lang('Cash In hand') ?></p>
                    </div>
                    <div class="small-box padding1010 col-sm-4 bdarkGreen">
                        <h3><?= isset($head->total_cash_in) ? $this->sma->formatMoney($head->total_cash_in) : '0.00' ?></h3>
                        <p><?= lang('Total Cash-In') ?></p>
                    </div>
                    <div class="small-box padding1010 col-sm-4 borange">
                        <h3><?= isset($head->total_cash_out) ? $this->sma->formatMoney($head->total_cash_out) : '0.00' ?></h3>
                        <p><?= lang('Total Cash-Out') ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('Cash Management'); ?></h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0" class="table table_theme">
                        <thead>
                            <tr class="active">
                                ...
                                <th class="col-xs-3"><?= lang("reference"); ?></th>
