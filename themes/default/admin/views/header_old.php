                                        ...
                                        ?>
                                            ...
                                            <li class="mm_cash">
                                                <a class="dropmenu" href="#">
                                                    ...
                                                    <span class="text"> <?= lang('Cash'); ?> </span>
                                                    <span class="chevron closed"></span>
                                                </a>
                                                <ul>
                                                    <li id="purchases_expenses">
                                                        <a class="submenu" href="<?= admin_url('purchases/cash_management'); ?>">
                                                            <i class="fa fa-dollar"></i>
                                                            <span class="text"> <?= lang('Cash Management'); ?></span>
                                                        </a>
                                                    </li>
                                                    <li id="purchases_add_expense">
                                                        <a class="submenu" href="<?= admin_url('purchases/add_cash'); ?>" data-toggle="modal" data-target="#myModal">
                                                            <i class="fa fa-plus-circle"></i>
                                                            <span class="text"> <?= lang('Add/Remove Cash'); ?></span>
                                                        </a>
                                                    </li>
                                            ...
                                            <li class="mm_products">
                                                ...
                                                <ul>
                                                    ...
                                                    <li id="products_production_quantity_adjustments">
                                                        <a class="submenu" href="<?= admin_url('products/production_quantity_adjustments'); ?>">
                                                            <i class="fa fa-filter"></i>
                                                            <span class="text"> <?= lang('production_quantity_adjustments'); ?></span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li id="products_add_adjustment_production">
                                                        <a class="submenu" href="<?= admin_url('products/add_adjustment_production'); ?>">
                                                            <i class="fa fa-filter"></i>
                                                            <span class="text"> <?= lang('add_adjustment_production'); ?></span>
                                                        </a>
                                                    </li>
                                            ...
                                            <li class="mm_branches">
                                                <a class="submenu" href="<?= admin_url('branches'); ?>">
                                            ...
                                            <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                                ...
                                                <ul>
                                                    <?php if ($Owner) { ?>
                                                        ...
                                                        <li id="billers_index">
                                                            <a class="submenu" <?php if ($count1 <= 50) { ?> href="<?= admin_url('billers/add'); ?>" data-toggle="modal" data-target="#myModal" <?php } else { ?> onclick="alert('You cannot add more than 50 billers please contact to administrator!');" <?php } ?>>
                                                    ...
                                                    <li id="suppliers_index">
                                                        <a class="submenu" <?php if ($count3 <= 50) { ?> href="<?= admin_url('suppliers/add'); ?>" data-toggle="modal" data-target="#myModal" <?php } else { ?> onclick="alert('You cannot add more than 50 suppliers please contact to administrator!');" <?php } ?>>
