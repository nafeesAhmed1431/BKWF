        ...
        <div class="fullForm">
                ...
                <div class="fullFormItemsList">
                    ...
                    <div class="fullFormItemsListGroup">
                        ...
                        <div class="fullFormItemsListGroupInput">
                            ...
                            echo form_dropdown('language', $lang, $Settings->language, 'class="select2Dropdown" id="language" name="language" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        ...
                        <div class="fullFormItemsListGroupInput">
                            ...
                            echo form_dropdown('currency', $cu, $Settings->default_currency, 'class="select2Dropdown" id="defaultcurrency" name="defaultcurrency" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Accounting Method *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $am = array(0 => 'FIFO (First In First Out)', 1 => 'LIFO (Last In First Out)', 2 => 'AVCO (Average Cost Method)');
                            echo form_dropdown('accounting_method', $am, $Settings->accounting_method, 'class="select2Dropdown" id="accounting_method" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Default Email *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('email', $Settings->default_email, 'class="systemInput" required="required" id="email"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Default Customer Group *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            ...
                            echo form_dropdown('customer_group', $pgs, $Settings->customer_group, 'class="select2Dropdown" id="customer_group" style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Default Price Group *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            ...
                            echo form_dropdown('price_group', $cgs, $Settings->price_group, 'class="select2Dropdown" id="price_group" style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Maintenance Mode *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('mmode', $wm, (isset($_POST['mmode']) ? $_POST['mmode'] : $Settings->mmode), 'class="select2Dropdown" required="required" id="mmode" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Theme *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $themes = array(
                            ...
                            echo form_dropdown('theme', $themes, $Settings->theme, 'id="theme" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">RTL Support *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('rtl', $ps, $Settings->rtl, 'id="rtl" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Login Captcha *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('captcha', $ps, $Settings->captcha, 'id="captcha" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Number of days to disable editing *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('disable_editing', $Settings->disable_editing, 'class="systemInput" id="disable_editing" required="required"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Rows per page *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $rppopts = array('10' => '10', '25' => '25', '50' => '50',  '100' => '100', '-1' => lang('all') . ' (' . lang('not_recommended') . ')');
                            echo form_dropdown('rows_per_page', $rppopts, $Settings->rows_per_page, 'id="rows_per_page" class="select2Dropdown" style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Date Format *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            ...
                            echo form_dropdown('dateformat', $dt, $Settings->dateformat, 'id="dateformat" class="select2Dropdown" style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Timezone *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            ...
                            ?>
                            <?= form_dropdown('timezone', $tz, TIMEZONE, 'class="select2Dropdown" id="timezone" required="required"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Calender *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $opt_cal = array(1 => lang('private'), 0 => lang('shared'));
                            echo form_dropdown('restrict_calendar', $opt_cal, $Settings->restrict_calendar, 'class="select2Dropdown" required="required" id="restrict_calendar" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Default Warehouse *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            ...
                            echo form_dropdown('warehouse', $wh, $Settings->default_warehouse, 'class="select2Dropdown" id="warehouse" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Default Biller *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $bl[""] = "";
                            ...
                            echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $Settings->default_biller), 'id="biller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="select2Dropdown" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">PDF Library *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php $pdflibs = ['mpdf' => 'mPDF', 'dompdf' => 'Dompdf']; ?>
                            <?= form_dropdown('pdf_lib', $pdflibs, $Settings->pdf_lib, 'class="select2Dropdown" id="pdf_lib" required="required"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">APIs Feature *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_dropdown('apis', $ps, $Settings->apis, 'class="select2Dropdown" id="apis" required="required"'); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="fullFormItems">
                ...
                <div class="fullFormItemsList">
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="sitename">Product Tax *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('tax_rate', $ps, $Settings->default_tax_rate, 'class="select2Dropdown" id="tax_rate" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="language">Racks *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('racks', $ps, $Settings->racks, 'id="racks" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Product Variants *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('attributes', $ps, $Settings->attributes, 'id="attributes" class="select2Dropdown"  required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Product Expiry *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('product_expiry', $ps, $Settings->product_expiry, 'id="product_expiry" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Remove expired products from stock *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $re_opts = array(0 => lang('no') . ', ' . lang('i_ll_remove'), 1 => lang('yes') . ', ' . lang('remove_automatically'));
                            echo form_dropdown('remove_expired', $re_opts, $Settings->remove_expired, 'id="remove_expired" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Image Size (Width :
                                Height) *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <div class="fullFormItemsListGroupInputGroup">
                                <div class="fullFormItemsListGroupInputGroupInput">
                                    <?= form_input('iwidth', $Settings->iwidth, 'class="systemInput" id="iwidth" placeholder="image width" required="required"'); ?>
                                </div>
                                <div class="fullFormItemsListGroupInputGroupInput">
                                    <?= form_input('iheight', $Settings->iheight, 'class="systemInput" id="iheight" placeholder="image height" required="required"'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Thumbnail Size (Width : Height) *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <div class="fullFormItemsListGroupInputGroup">
                                <div class="fullFormItemsListGroupInputGroupInput">
                                    <?= form_input('twidth', $Settings->twidth, 'class="systemInput" id="twidth" placeholder="thumbnail width" required="required"'); ?>
                                </div>
                                <div class="fullFormItemsListGroupInputGroupInput">
                                    <?= form_input('theight', $Settings->theight, 'class="systemInput" id="theight" placeholder="thumbnail height" required="required"'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Watermark *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('watermark', $wm, (isset($_POST['watermark']) ? $_POST['watermark'] : $Settings->watermark), 'class="select2Dropdown" required="required" id="watermark" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Display warehouse products *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $dopts = array(0 => lang('hide_with_0_qty'), 1 => lang('show_with_0_qty'));
                            echo form_dropdown('display_all_products', $dopts, (isset($_POST['display_all_products']) ? $_POST['display_all_products'] : $Settings->display_all_products), 'class="select2Dropdown" required="required" id="display_all_products" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Barcode separator *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $bcopts = array('-' => lang('dash'), '.' => lang('dot'), '~' => lang('tilde'), '_' => lang('underscore'));
                            echo form_dropdown('barcode_separator', $bcopts, (isset($_POST['barcode_separator']) ? $_POST['barcode_separator'] : $Settings->barcode_separator), 'class="select2Dropdown" required="required" id="barcode_separator" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Barcode Renderer *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $bcropts = array(1 => lang('image'), 0 => lang('svg'));
                            echo form_dropdown('barcode_renderer', $bcropts, (isset($_POST['barcode_renderer']) ? $_POST['barcode_renderer'] : $Settings->barcode_img), 'class="select2Dropdown" required="required" id="barcode_renderer" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Update cost with purchase *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_dropdown('update_cost', $wm, $Settings->update_cost, 'class="select2Dropdown" id="update_cost" required="required"'); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="fullFormItems">
                ...
                <div class="fullFormItemsList">
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="sitename">Over Selling *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $opt = array(1 => lang('yes'), 0 => lang('no'));
                            echo form_dropdown('restrict_sale', $opt, $Settings->overselling, 'class="select2Dropdown" id="overselling" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="language">Reference Format *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $ref = array(1 => lang('prefix_year_no'), 2 => lang('prefix_month_year_no'), 3 => lang('sequence_number'), 4 => lang('random_number'));
                            echo form_dropdown('reference_format', $ref, $Settings->reference_format, 'class="select2Dropdown" required="required" id="reference_format" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Order Tax *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            ...
                            echo form_dropdown('tax_rate2', $tr, $Settings->default_tax_rate2, 'id="tax_rate2" class="select2Dropdown" required="required" style="width:100%;"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Product Level Discount *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('product_discount', $ps, $Settings->product_discount, 'id="product_discount" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Product Serial *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('product_serial', $ps, $Settings->product_serial, 'id="product_serial" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Auto Detect Barcode *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            echo form_dropdown('detect_barcode', $ps, $Settings->auto_detect_barcode, 'id="detect_barcode" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Products count to fix barcode input *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('bc_fix', $Settings->bc_fix, 'class="systemInput" required="required" id="bc_fix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Cart Item Addition Method *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $ia = array(0 => lang('add_new_item'), 1 => lang('increase_quantity_if_item_exist'));
                            echo form_dropdown('item_addition', $ia, $Settings->item_addition, 'id="item_addition" class="select2Dropdown" required="required" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Default Order Page Focus *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $sfopts = array(0 => lang('add_item_input'), 1 => lang('last_order_item'));
                            echo form_dropdown('set_focus', $sfopts, (isset($_POST['set_focus']) ? $_POST['set_focus'] : $Settings->set_focus), 'id="set_focus" data-placeholder="' . lang("select") . ' ' . lang("set_focus") . '" required="required" class="select2Dropdown" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Invoice View *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $opt_inv = array(1 => lang('tax_invoice'), 0 => lang('standard'), 2 => lang('indian_gst'));
                            echo form_dropdown('invoice_view', $opt_inv, $Settings->invoice_view, 'class="select2Dropdown" required="required" id="invoice_view" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="fullFormItems">
                ...
                <div class="fullFormItemsList">
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="sitename">Sales Reference Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('sales_prefix', $Settings->sales_prefix, 'class="systemInput" id="sales_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="language">Return Sale Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('return_prefix', $Settings->return_prefix, 'class="systemInput" id="return_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Payment Reference Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('payment_prefix', $Settings->payment_prefix, 'class="systemInput" id="payment_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Purchase Payment Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('ppayment_prefix', $Settings->ppayment_prefix, 'class="systemInput" id="ppayment_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Delivery Reference Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('delivery_prefix', $Settings->delivery_prefix, 'class="systemInput" id="delivery_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Quotation Reference Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('quote_prefix', $Settings->quote_prefix, 'class="systemInput" id="quote_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Purchase Reference Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('purchase_prefix', $Settings->purchase_prefix, 'class="systemInput" id="purchase_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Return Purchase Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('returnp_prefix', $Settings->returnp_prefix, 'class="systemInput" id="returnp_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Transfer Reference Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('transfer_prefix', $Settings->transfer_prefix, 'class="systemInput" id="transfer_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Expense Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('expense_prefix', $Settings->expense_prefix, 'class="systemInput" id="expense_prefix"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Quantity Adjustment Prefix</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('qa_prefix', $Settings->qa_prefix, 'class="systemInput" id="qa_prefix"'); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="fullFormItems">
                <div class="fullFormItemsHeading">
                    <h3>Money and Number Format</h3>
                </div>
                <div class="fullFormItemsList">
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="sitename">Decimals *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $decimals = array(0 => lang('disable'), 1 => '1', 2 => '2', 3 => '3', 4 => '4');
                            echo form_dropdown('decimals', $decimals, $Settings->decimals, 'class="select2Dropdown" id="decimals"  style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="language">Quantity Decimals *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $qty_decimals = array(0 => lang('disable'), 1 => '1', 2 => '2', 3 => '3', 4 => '4');
                            echo form_dropdown('qty_decimals', $qty_decimals, $Settings->qty_decimals, 'class="select2Dropdown" id="qty_decimals"  style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">South Asian Countries Currency Format *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?= form_dropdown('sac', $ps, set_value('sac', $Settings->sac), 'class="select2Dropdown" id="sac"  required="required"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Decimals Separator *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $dec_point = array('.' => lang('dot'), ',' => lang('comma'));
                            echo form_dropdown('decimals_sep', $dec_point, $Settings->decimals_sep, 'class="select2Dropdown" id="decimals_sep"  style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Thousands Separator *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $thousands_sep = array('.' => lang('dot'), ',' => lang('comma'), '0' => lang('space'));
                            echo form_dropdown('thousands_sep', $thousands_sep, $Settings->thousands_sep, 'class="select2Dropdown" id="thousands_sep"  style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="defaultcurrency">Display Currency Symbol *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php $opts = array(0 => lang('disable'), 1 => lang('before'), 2 => lang('after')); ?>
                            <?= form_dropdown('display_symbol', $opts, $Settings->display_symbol, 'class="select2Dropdown" id="display_symbol" style="width:100%;" required="required"'); ?>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                        ...
                        <div class="fullFormItemsListGroupInput">
                            <?= form_input('symbol', $Settings->symbol, 'class="systemInput" id="symbol" style="width:100%;"'); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="fullFormItems">
                ...
                <div class="fullFormItemsList">
                    <div class="fullFormItemsListGroup">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="sitename">Email Protocol *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <?php
                            $popt = array('mail' => 'PHP Mail Function', 'sendmail' => 'Send Mail', 'smtp' => 'SMTP');
                            echo form_dropdown('protocol', $popt, $Settings->protocol, 'class="select2Dropdown" id="protocol"  style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="fullFormItems">
                ...
                <div class="fullFormItemsList">
                    <div class="fullFormItemsListGroup fullFormItemsListGroupIcon">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="sitename">Customer Award Points *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <div class="fullFormItemsListGroupInputGroup fullFormItemsListGroupInputGroupIcon">
                                <div class="fullFormItemsListGroupInput">
                                    <?= lang('each_spent'); ?><br>
                                    <?= form_input('each_spent', $this->sma->formatDecimal($Settings->each_spent), 'class="systemInput"'); ?>
                                </div>
                                <div class="fullFormItemsListGroupInputIcon">
                                    <img src="<?= $assets ?>images/icon/full-right.svg" alt="">
                                </div>
                                <div class="fullFormItemsListGroupInput">
                                    <?= lang('award_points'); ?><br>
                                    <?= form_input('ca_point', $Settings->ca_point, 'class="systemInput"'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="fullFormItemsListGroup fullFormItemsListGroupIcon">
                        <div class="fullFormItemsListGroupLabel">
                            <label for="sitename">Staff Award Points *</label>
                        </div>
                        <div class="fullFormItemsListGroupInput">
                            <div class="fullFormItemsListGroupInputGroup fullFormItemsListGroupInputGroupIcon">
                                <div class="fullFormItemsListGroupInput">
                                    <?= lang('each_in_sale'); ?><br>
                                    <?= form_input('each_sale', $this->sma->formatDecimal($Settings->each_sale), 'class="systemInput"'); ?>
                                </div>
                                <div class="fullFormItemsListGroupInputIcon">
                                    <img src="<?= $assets ?>images/icon/full-right.svg" alt="">
                                </div>
                                <div class="fullFormItemsListGroupInput">
                                    <?= lang('award_points'); ?><br>
                                    <?= form_input('sa_point', $Settings->sa_point, 'class="systemInput"'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <li class="dropdown"><a href="<?= admin_url('system_settings/skrill') ?>" class="toggle_down"><i class="icon fa fa-bank"></i><span class="padding-right-10"><?= lang('skrill'); ?></span></a></li>
            </ul>
        </div>
    </div>
