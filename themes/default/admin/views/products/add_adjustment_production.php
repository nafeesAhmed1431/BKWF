...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            source: '<?= admin_url('products/qa_suggestions_production'); ?>',
            minLength: 1,
            autoFocus: false,
            delay: 250,
            ...
            select: function (event, ui) {
                ...
                if (ui.item.id !== 0) {
                    var row = add_adjustment_item(ui.item,1);
                    if (row)
                        $(this).val('');
                } else {
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_adjustment_production'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("products/add_adjustment_production".($count_id ? '/'.$count_id : ''), $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) { ?>
