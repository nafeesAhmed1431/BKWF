            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        $opts = array('standard' => lang('standard'), 'combo' => lang('combo'), 'production' => lang('production'));
                    ...
                    <div class="form-group standard stqt">
    ...
    $(document).ready(function () {
        ...
        $('#type').change(function () {
            ...
            if (t !== 'standard') {
                ...
                // if($("#combo_item_as_production").val() == 1){
                //     if(t === 'combo'){
                //         //alert('2nd');
                //         $('.stqt').slideDown();
                //     }
