...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (!localStorage.getItem('qucurrency')) {
            localStorage.setItem('qucurrency', <?=$Settings->default_currency_id;?>);
        }
        ItemnTotals();
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if ($Settings->default_currency) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("order_currency", "qucurrency"); ?>
                                    <?php
                                    $currtr[""] = "";
                                    foreach ($currencies as $curr) {
                                        $currtr[$curr->id] = $curr->name;
                                    }
                                    echo form_dropdown('order_currency', $currtr, (isset($_POST['order_currency']) ? $_POST['order_currency'] : $Settings->default_currency_id), 'id="qucurrency" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("order_currency") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        <?php } ?>
