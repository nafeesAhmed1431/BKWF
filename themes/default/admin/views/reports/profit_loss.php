            ...
            <div class="col-lg-12">
                ...
                <?php foreach ($warehouses_report as $warehouse_report) { ?>
                    ...
                    <div class="col-sm-5">
                        <div class="small-box padding1010 bblue">
                                <i class="icon fa fa-money"></i>                                
                                <?= '<h3 class="bold">'.$this->sma->formatMoney((($warehouse_report['total_sales']->total_amount-$warehouse_report['total_sales']->tax))-($warehouse_report['total_purchases']->total_amount-$warehouse_report['total_purchases']->tax)-($warehouse_report['total_returns']->total_amount-$warehouse_report['total_returns']->tax)-($warehouse_report['total_expenses']->total_amount)).'</h3>'; ?>
                                <p>
                                <?= lang('net_sales').' - '.lang('net_purchases').' - '.lang('net_returns').' - '.' '.$warehouse_report['total_expenses']->total.' '.lang('expenses'); ?>
                                </p>
                        </div>
                    </div>
                <?php } ?>
