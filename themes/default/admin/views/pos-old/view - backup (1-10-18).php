            ...
            <div class="row">
                ...
                <div class="col-lg-4 top-second">
                    <address>
                        ...
                        Acc Name: Laptop Direct<br>
                        Acc #: 12345<br>
                        Bank: CABS<br>
                        Branch: North Bridge<br>
                        Swift: Cabszwha<br>
                    </address>
                </div>

                <div class="col-lg-4 top-third">
                    <address>
                        <strong><font color="#21B9BB">TAX INVOICE</font></strong><br>
                        <?php
                ...
                <div class = "row" style = "clear:both;">
                    <table rules="all" style = "border:1px solid;text-align: center;" width = "50%" class = "col-lg-4 pull-right">
                            <tbody>
                            ...
                            <tr>
                                <?php
                                foreach($rows as $row){
                                    $total1 += $row->quantity * $row->unit_price;
                                    $vat1 += $row->item_tax;
                                    $nettotal1 += ($row->quantity * $row->unit_price) + $row->item_tax;
                                }
                                ?>
                ...
                <div class = "row">
                     ...
                     <div class = "col-lg-7 col-sm-7 col-xs-7">
                        <table rules="all" style = "border:1px solid;text-align: center; width:57%;" class = "col-lg-4 pull-right">
                                <tbody>
                                <tr>
                                    <td style="font-weight:bold;">Customer Account No: </td>
                                    <td>0000</td>
                                    
                                </tr>
                                <tr>
                                    <td style="font-weight:bold;">Customer VAT Reg No: </td>
                                    <td><?php if(!empty($customer->vat_no)){echo $customer->vat_no;}else{echo " ";} ?></td>
                                </tr>
                                </tbody>
                        </table>
                        <table rules="all" style = "border:1px solid;text-align: center; width:100%;margin-top:7px;" class = "col-lg-4 pull-right">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $this->sma->hrld($inv->date); ?></td>
                                </tr>
                                </tbody>
                        </table>
                     </div>  
                ...
                <div class="row">
                   ...
                   <table rules="all" style = "border:1px solid; width:96%; margin:0 auto;">
                                <tbody>
                                <tr style = "font-weight:bold;">
                                    <td style = "padding-left:2px;">Code</td>
                                    <td style = "padding-left:2px;">Description</td>
                                ...
                                <?php $tot = 0; foreach ($rows as $row) { ?>
                                        <tr>
                                            ...
                                            <td style = "text-align:center;"><?php echo $row->quantity * $row->net_unit_price; $tot = $row->quantity * $row->net_unit_price; $totalprice += $row->quantity * $row->net_unit_price; ?></td>
                                            <td style = "text-align:center;"><?php echo $row->item_tax; $totalvat += $row->item_tax; ?></td>
                                            <td style = "text-align:center;"><?php echo $row->subtotal; $nettotal += $row->item_tax + $tot;  ?></td>
                                        </tr>
                                <?php }  ?>
                                <!-- <tr>
                ...
                <div class  = "row">
                        ...
                        <div class = "col-lg-6 col-lg-6 col-sm-6 col-xs-6">
