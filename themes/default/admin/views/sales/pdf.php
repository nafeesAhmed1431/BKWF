            ...
            <div id="receipt-data">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 top-third">
                            ...
                            <table rules="all"  class = "col-lg-7 cusacctable">
                                <tbody>
                                <tr>
                                    <td style = "font-weight:bold; text-align:center; width:110px;" >Doc Number</td>
                                    <td style = "font-weight:bold; text-align:center; width:70px;">Order No:</td>
                                    <td style = "font-weight:bold; text-align:center; width:80px;">Sales Rep</td>
                                    <td style = "font-weight:bold; text-align:center; width:60px;">Date</td>
                                </tr>
                                <tr>
                                    <td style = "text-align:center;"><?php echo$inv->reference_no; ?></td>
                                    <td style = "text-align:center;"><?php echo $inv->id; ?> </td>
                                    <td style = "text-align:center;"><?php echo $created_by->first_name." ".$created_by->last_name; ?></td>
                                    <td style = "text-align:center;"><?php echo $this->sma->hrsd($inv->date); ?></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-lg-4" >
                        <!--blank space to the right of the customer details for logo-->
                            <img src="<?php echo base_url(); ?>assets/images/invoice-header.jpg" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class = "col-lg-6 col-sm-6 col-xs-6">
                            <div style = "border:1px solid;width:100%;padding:5px;line-height:15px;margin-top:10px;">*No Warranty on PSU's, power adaptors, batteries, ink & toner cartridges*Please allow at least 4-6 months for any warranty claims. Terms and conditions accepted by signatory. E&OE. All warranties handled directly by authorised warranty center.</div>
                        </div>
