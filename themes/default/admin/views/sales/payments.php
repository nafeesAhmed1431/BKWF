                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <?php if ($payment->paid_by != 'gift_card') { ?>
                                            ...
                                            <a href="<?= ($payment->paid_by == 'Cheque') ? admin_url('sales/edit_cheque_payment/' . $payment->id) : admin_url('sales/edit_payment/' . $payment->id) ;?>"data-toggle="modal" data-target="#myModal2"><i class="fa fa-edit"></i></a>
                                            <a href="#" class="po"
