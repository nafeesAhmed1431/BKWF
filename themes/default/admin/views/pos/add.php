...
<body class="posBody">
    ...
    <div id="wrapper" class="posWrapper">
        <header id="header" class="navbar posHeader">
            <div class="row">
                ...
                <div class="btnContent posBtnContent">
                    <div class="btnContentItem">
                        <a href="<?= admin_url('welcome') ?>" class="headerBtn">
                            <div class="btnIcon">
                                <img src="<?= $assets ?>images/icon/dashboard.svg" alt="" class="svg">
                            </div>
                            Dashboard
                        </a>
                    </div>
                    <div class="btnContentItem">
                        <a title="<?= lang('shortcuts') ?>" data-placement="bottom" href="#" data-toggle="modal" data-target="#sckModal" class="headerBtn">
                            <div class="btnIcon">
                                <img src="<?= $assets ?>images/icon/shortcut.svg" alt="" class="svg">
                            </div>
                            Shortcuts
                        </a>
                    </div>
                    <div class="btnContentItem">
                        <a id="register_details" title="<?= lang('register_details') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('pos/register_details') ?>" data-toggle="modal" data-target="#myModal" class="headerBtn">
                            <div class="btnIcon">
                                <img src="<?= $assets ?>images/icon/regDetail.svg" alt="" class="svg">
                            </div>
                            Register Detail
                        </a>
                    </div>
                    <div class="btnContentItem">
                        <a class="headerBtn" id="close_register" title="<?= lang('close_register') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('pos/close_register') ?>" data-toggle="modal" data-target="#closeReg">
                            <div class="btnIcon">
                                <img src="<?= $assets ?>images/icon/closeReg.svg" alt="" class="svg">
                            </div>
                            Close Register
                        </a>
                    </div>
                    <div class="btnContentItem">
                        <a class="headerBtn" id="add_expense" title="<?= lang('add_expense') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('purchases/add_expense') ?>" data-toggle="modal" data-target="#addExp">
                            <div class="btnIcon">
                                <img src="<?= $assets ?>images/icon/addExp.svg" alt="" class="svg">
                            </div>
                            Add Expense
                        </a>
                    </div>
                    <div class="btnContentItem">
                        <a class="headerBtn" id="today_profit" title="<?= lang('today_profit') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('reports/profit') ?>" data-toggle="modal" data-target="#todayPro">
                            <div class="btnIcon">
                                <img src="<?= $assets ?>images/icon/todayPro.svg" alt="" class="svg">
                            </div>
                            Today’s Profit
                        </a>
                    </div>
                    <div class="btnContentItem">
                        <a class="headerBtn" id="today_sale" title="<?= lang('today_sale') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('pos/today_sale') ?>" data-toggle="modal" data-target="#todaySale">
                            <div class="btnIcon">
                                <img src="<?= $assets ?>images/icon/todaySale.svg" alt="" class="svg">
                            </div>
                            Today’s Sale
                        </a>
                    </div>
                ...
                <!-- <div class="header-nav">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown">
                            <a class="btn blightOrange pos-tip" id="opened_bills" title="<?= lang('suspended_sales') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('pos/opened_bills') ?>" data-toggle="ajax">
                                <i class="fa fa-th"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="register_details" title="<?= lang('register_details') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('pos/register_details') ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-check-circle"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a class="btn borange pos-tip" id="close_register" title="<?= lang('close_register') ?>" data-placement="bottom" data-html="true" data-backdrop="static" href="<?= admin_url('pos/close_register') ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-times-circle"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a class="btn borange pos-tip" id="add_expense" title="<?= lang('add_expense') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('purchases/add_expense') ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-dollar"></i>
                            </a>
                        </li>
                        <?php if ($Owner) { ?>
                            <li class="dropdown">
                                <a class="btn bdarkGreen pos-tip" id="today_profit" title="<?= lang('today_profit') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('reports/profit') ?>" data-toggle="modal" data-target="#myModal">
                        ...
                        <?php if ($Owner || $Admin) { ?>
                            <li class="dropdown">
                                <a class="btn bdarkGreen pos-tip" id="today_sale" title="<?= lang('today_sale') ?>" data-placement="bottom" data-html="true" href="<?= admin_url('pos/today_sale') ?>" data-toggle="modal" data-target="#myModal">
                ...
                <div class="userContent posUserContent">
                    <div class="userContentDropdown">
                        <div class="userContentDrop">
                            <span><img src="<?= $this->session->userdata('avatar') ? base_url() . 'assets/uploads/avatars/thumbs/' . $this->session->userdata('avatar') : $assets . 'images/' . $this->session->userdata('gender') . '.png'; ?>" alt=""></span>
                                ...
                                <div class="no-print">
                                    ...
                                    <div class="form-group">
                                        ...
                                        foreach ($currencies as $curr) {
                                            $curr_tr[$curr->id] = $curr->name;
                                        }
                                        echo form_dropdown('currency', $curr_tr, (isset($_POST['currency']) ? $_POST['currency'] : $Settings->default_currency_id), 'id="poscurrency" class="form-control pos-input-tip" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("currency") . '" required="required" style="width:100%;" ');
                                        ?>
                                    </div>
                                ...
                                <div class="quick-menu">
                                    <div id="proContainer">
                                        <div id="ajaxproducts">
                                            ...
                                            <!-- GIFT Cards...commented by Ali bin Younas -->
    ...
    <div class="modal fade in" id="closeReg" tabindex="-1" role="dialog" aria-labelledby="closeRegLabel" aria-hidden="true"></div>
    <div class="modal fade in" id="addExp" tabindex="-1" role="dialog" aria-labelledby="addExpLabel" aria-hidden="true"></div>
    <div class="modal fade in" id="todayPro" tabindex="-1" role="dialog" aria-labelledby="todayProLabel" aria-hidden="true"></div>
    <div class="modal fade in" id="todaySale" tabindex="-1" role="dialog" aria-labelledby="todaySaleLabel" aria-hidden="true"></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            <?php if ($suspend_sale) { ?>
                ...
                localStorage.setItem('poscurrency', '<?= $suspend_sale->currency_id; ?>');
            ...
            <?php if ($old_sale) { ?>
                ...
                localStorage.setItem('poscurrency', '<?= $old_sale->currency_id; ?>');
