...
function loadItems(t=0) {
    ...
    if (localStorage.getItem('qaitems')) {
        ...
        $.each(sortedItems, function () {
            ...
            if(t==1){
                tr_html += '<td><select name="type[]" class="form-contol select rtype" style="width:100%;"><option value="addition"'+(type == 'addition' ? ' selected' : '')+'>'+type_opt.addition+'</option></select></td>';
            }else{
 ...
 * @returns {Boolean}
 ---------------------------- */
function add_adjustment_item(item,t=0) {
