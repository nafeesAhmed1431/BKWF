...
$('#poscurrency').change(function (e) {
    localStorage.setItem('poscurrency', $(this).val());
});
if (poscurrency = localStorage.getItem('poscurrency')) {
    $('#poscurrency').select2('val', poscurrency);
}
...
// Order currency calculation
if (site.settings.currency != 0) {
    $('#poscurrency').change(function () {
        localStorage.setItem('poscurrency', $(this).val());
        loadItems();
        return;
    });
...
function loadItems() {
    ...
    if (localStorage.getItem('positems')) {
        ...
        if (site.settings.default_currency_id != 0) {
            if (poscurrency = localStorage.getItem('poscurrency')) {
                $.each(currencies, function () {
                    if (this.id == poscurrency) {
        ...
        $.each(sortedItems, function () {
            ...
            //updating unit_price according to currency rate // Updated by: Ali Bin Younas
