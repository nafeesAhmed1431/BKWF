...
class MY_Controller extends CI_Controller
{
    ...
    function page_construct($page, $meta = array(), $data = array())
    {
        ...
        $data['user'] = [
            'id' => $this->session->userdata('user_id'), 'username' => $this->session->userdata('username'),
            'email' => $this->session->userdata('email'), 'group' => $this->session->userdata('group_id'),
            'rights' => ['view' => $this->session->userdata('view_right'), 'edit' => $this->session->userdata('edit_right')],
